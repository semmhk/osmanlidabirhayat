...
void main() {
  group('3 Sistem Boşluğu Kapatma Testleri', () {
    ...
    test('1. Toplam 310 olay (Kuruluş 138 + Yükselme 101 + Duraklama 71) yüklenmeli ve benzersiz ID\'lere sahip olmalı', () {
      ...
      expect(o1.length + o2.length + o3.length, equals(310));
