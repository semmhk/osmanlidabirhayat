  ...
  static const Map<String, Donem> donemler = {
    ...
    'duraklama': Donem(
      ...
      padisahlar: [
        ...
        Padisah(id: 'mehmed4', isim: 'IV. Mehmed (Avcı Mehmed)', baslangic: 1648, bitis: 1687, portreGorsel: 'assets/padisahlar/mehmed4.jpg'),
        Padisah(id: 'suleyman2', isim: 'II. Süleyman', baslangic: 1687, bitis: 1691, portreGorsel: 'assets/padisahlar/suleyman2.jpg'),
        Padisah(id: 'ahmed2', isim: 'II. Ahmed', baslangic: 1691, bitis: 1695, portreGorsel: 'assets/padisahlar/ahmed2.jpg'),
        Padisah(id: 'mustafa2', isim: 'II. Mustafa', baslangic: 1695, bitis: 1703, portreGorsel: 'assets/padisahlar/mustafa2.jpg'),
      ],
    ),
    'gerileme': Donem(
      id: 'gerileme',
      ...
      yilMax: 1792,
      padisahlar: [
        Padisah(id: 'ahmed3', isim: 'III. Ahmed', baslangic: 1703, bitis: 1730, portreGorsel: 'assets/padisahlar/ahmed3.jpg'),
        Padisah(id: 'mahmud1', isim: 'I. Mahmud', baslangic: 1730, bitis: 1754, portreGorsel: 'assets/padisahlar/mahmud1.jpg'),
        Padisah(id: 'osman3', isim: 'III. Osman', baslangic: 1754, bitis: 1757, portreGorsel: 'assets/padisahlar/osman3.jpg'),
        Padisah(id: 'mustafa3', isim: 'III. Mustafa', baslangic: 1757, bitis: 1774, portreGorsel: 'assets/padisahlar/mustafa3.jpg'),
        Padisah(id: 'abdulhamid1', isim: 'I. Abdülhamid', baslangic: 1774, bitis: 1789, portreGorsel: 'assets/padisahlar/abdulhamid1.jpg'),
    ...
    'dagilma': Donem(
      ...
      yilMax: 1922,
      padisahlar: [
        Padisah(id: 'mustafa4', isim: 'IV. Mustafa', baslangic: 1807, bitis: 1808, portreGorsel: 'assets/padisahlar/mustafa4.jpg'),
        Padisah(id: 'mahmud2', isim: 'II. Mahmud', baslangic: 1808, bitis: 1839, portreGorsel: 'assets/padisahlar/ii_mahmud.jpg'),
        Padisah(id: 'abdulmecid1', isim: 'Sultan Abdülmecid', baslangic: 1839, bitis: 1861, portreGorsel: 'assets/padisahlar/abdulmecid1.jpg'),
        Padisah(id: 'abdulaziz', isim: 'Sultan Abdülaziz', baslangic: 1861, bitis: 1876, portreGorsel: 'assets/padisahlar/abdulaziz.jpg'),
        Padisah(id: 'murad5', isim: 'V. Murad', baslangic: 1876, bitis: 1876, portreGorsel: 'assets/padisahlar/murad5.jpg'),
        Padisah(id: 'abdulhamid2', isim: 'II. Abdülhamid', baslangic: 1876, bitis: 1909, portreGorsel: 'assets/padisahlar/abdulhamid2.jpg'),
        Padisah(id: 'mehmed5', isim: 'V. Mehmed (Reşad)', baslangic: 1909, bitis: 1918, portreGorsel: 'assets/padisahlar/mehmed5.jpg'),
        Padisah(id: 'mehmed6', isim: 'VI. Mehmed (Vahdeddin)', baslangic: 1918, bitis: 1922, portreGorsel: 'assets/padisahlar/mehmed6.jpg'),
      ],
    ),
  };
